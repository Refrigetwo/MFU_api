...
module.exports = {
    add: function (req, res, next) {
        pool.getConnection(function(err, connection) {
            ...
            connection.query($sql.insert, [param.did, param.uid, param.date, param.con], function(err, result) {
                if(result) {
                    result = {
                        code: 200,
                        msg:'增加成功'
    ...
    queryById: function (req, res, next) {
        ...
        pool.getConnection(function(err, connection) {
            var param = req.query || req.params;
            connection.query($sql.queryById, [param.did, param.uid,], function(err, result) {
                jsonWrite(res, result);
                connection.release();
